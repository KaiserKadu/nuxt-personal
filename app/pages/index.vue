...
<template>
  <div class="h-screen w-full absolute top-0 left-0 z-1">
    <CosmicPortal
      :crystalCount="12"
      :dimensionShift="1"
      accentColor="#07F5F4"
  ...
  <div class="z-2 absolute inset-0 flex items-center justify-between px-8">
    <Button variant="outline" @click="activatePortal"> Activate Portal </Button>
    <button class="cybr-btn">
      Cyber<span aria-hidden>_</span>
      <span aria-hidden class="cybr-btn__glitch">Cyber_</span>
      <span aria-hidden class="cybr-btn__tag">R25</span>
    </button>
    <!-- <Button @click="shiftDimensions"> Shift Dimensions </Button> -->
  </div>
  <ClientOnly>
    <SmoothCursor />
  </ClientOnly>
  <!-- <div class="h-screen w-full flex flex-row overflow-clip gap-4">
    <div class="flex flex-row items-center justify-center gap-4">
      <Button @click="activatePortal"> Activate Portal </Button>
      <Button @click="shiftDimensions"> Shift Dimensions </Button>
    </div>
  </div> -->
</template>
